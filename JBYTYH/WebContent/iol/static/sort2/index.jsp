        	...
        	<div class="sidebar" >
            	<h2 class="sidebar-header"><p>tools</p></h2>
            		<div id="menu" class="nav" style="overflow: hidden;">
            			<h1> <a href="${pageContext.request.contextPath}/tool/findAll2.do" target="iframe">油藏成本对比</a></h1>
            </div>
         </div>  
         <div class="content">
            	<iframe src="uploadSort2.jsp" id="iframe" name="iframe" width="100%" height="100%" frameborder="0"></iframe>
         </div>
        </div>
    </div>
</div>
