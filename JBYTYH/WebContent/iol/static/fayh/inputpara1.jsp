                ...
                <div class="table">
                    ...
                    <div class="table-box">
                        <table id="tab2">
                            ...
                            <tbody>
                                <tr>
                                	<th><input type="checkbox" checked="checked" disabled="disabled" name="sele1">基础方案</th>
                                    <td>基础方案</td>
                                    <td>${base.cost1 }</td>
                                ...
                                <tr>
                                	<th rowspan="2"><input type="checkbox" name="sele" value="1">开发技术</th>
                                    ...
                                    <input type="hidden" name="Q" value="${ty.inoil1 }">
                                ...
                                <tr>
                                    <th rowspan="4" style="background-color: white;"><input type="checkbox" name="sele"  value="2">措施方案</th>
                                ...
                                <tr>
                                	<th rowspan="2"><input type="checkbox" name="sele"  value="3">提高采收率</th>
