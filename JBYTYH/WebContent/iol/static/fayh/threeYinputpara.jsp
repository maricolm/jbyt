                            ...
                            <tbody>
                                ...
                                <c:choose>
                                	<c:when test="${ty1.limY==1 }">
                                		<tr>
		                                	<th rowspan="6"><input type="checkbox" name="sele" value="1">开发技术</th>
                                ...
                                <c:choose>
                                	<c:when test="${yl1.limY==1  }">
                                		<tr>
		                                    <th rowspan="12" style="background-color: white;"><input type="checkbox" name="sele" value="2">措施方案</th>
	                            ...
	                            <c:forEach	items="${hhs }" var="hhs1">
		                            <c:choose>
		                            	<c:when test="${hhs1.limY==1 }">
		                            		<tr>
			                                	<th rowspan="6"><input type="checkbox" name="sele" value="3">提高采收率</th>
