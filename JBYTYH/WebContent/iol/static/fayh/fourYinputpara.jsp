...
<body>
    <div id="saper-container">
        ...
        <div id="saper-bd">
        	<form id="form1" action="${pageContext.request.contextPath}/mix/getMixReList.do" method="post" class="saper-form">
	            <input name="year" value="4"  type="hidden">
                        ...
                        <table id="tab2">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="4">各年成本(万)</th>
                                    <th rowspan="2">各措施总成本(万)</th>
                                    <th colspan="2">井数(口)</th>
                                    <th colspan="4">各年增油(吨)</th>
                            ...
                            <tbody>
                                ...
                                <c:choose>
                                	<c:when test="${ty1.limY==1 }">
                                		<tr>
		                                	<th rowspan="8"><input type="checkbox" name="sele" value="1">开发技术</th>
                                ...
                                <c:choose>
                                	<c:when test="${yl1.limY==1  }">
                                		<tr>
		                                    <th rowspan="16" style="background-color: white;"><input type="checkbox" name="sele" value="2">措施方案</th>
	                            ...
	                            <c:forEach	items="${hhs }" var="hhs1">
		                            <c:choose>
		                            	<c:when test="${hhs1.limY==1 }">
		                            		<tr>
			                                	<th rowspan="8"><input type="checkbox" name="sele" value="3">提高采收率</th>
