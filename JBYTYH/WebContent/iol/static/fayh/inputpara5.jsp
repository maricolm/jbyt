                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td>${jmj.decrate }</td>
                                    <td>${jmj.balance }</td>
                                    <input type="hidden" name="C" value="${jmj.totalCost }">
                                    <input type="hidden" name="sj" value="${jmj.waterwell }">
                                    <input type="hidden" name="yj" value="${jmj.oilwell }">
                                    <input type="hidden" name="Q" value="${jmj.totalInoil }">
                                    <input type="hidden" name="djl" value="${jmj.decrate }">
                                    <input type="hidden" name="QQ" value="${jmj.balance }">
                                </tr>
                            </tbody>
                        </table>
                    </div>
