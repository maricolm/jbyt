    ...
    <div id="saper-container">
        <div id="saper-bd">
            ...
            <div class="subfiled-content">
                <form name="f1" id="f1" action="${pageContext.request.contextPath}/yh/getList.do" method="post">
                        ...
                        <div class="content">
                        	<div class="kv-item clearfix">
                                ...
                                <div class="kv-item-content" style="text-align: center;">
                                    <h3 style="color: red">${year }单模型</h3>
                                </div>
                            </div>
                            <div class="kv-item clearfix">
                                <label>油价：</label>
                            ...
                            <div class="kv-item clearfix">
                                <label>增油折现率：</label>
                                <div class="kv-item-content">
                                    <input type="text" name="rate" value="-0.1" id="t3">
                                    <small style="color: red"></small>
                                </div>
                            </div>
                            <div class="kv-item clearfix">
                                <label>基础增油产量：</label>
                                <div class="kv-item-content">
                                    <input type="text" name="c" value="52000" id="t4">&nbsp;吨
                                    <small style="color: red"></small>
                                </div>
                            </div>
                            <div class="kv-item clearfix">
